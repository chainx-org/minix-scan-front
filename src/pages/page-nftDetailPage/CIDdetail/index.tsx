...
function CIDdetail(): React.ReactElement {
    ...
    return (
        <div className='p-5'>
            <div className='pt-3 px-3 pb-4 font-semibold text-black-darker text-2xl leading-8'>CID 456735060785</div>
            <div className='flex flex-col border border-lang rounded-rounded'>
                ...
                <div className='flex flex-col p-4 bg-gray-dark border-b border-lang'>
                    <div className='flex items-center pb-2'>
                        ...
                        <span className='text-gray-lightest font-normal text-xs mr-1'>Created by</span>
                        <span className='text-blue-light font-normal text-xs'>Coming App</span>
                    </div>
                    <div className='flex flex-col'>
                        <div className='text-black-darker font-normal text-xs'>这里是简介描述两来下标容使要花度六听科始制儿与南们号声则清至规起少存能为先复车。</div>
                        <br /> 
                        <div className='text-black-darker font-normal text-xs'>这里是简介描述两来下标容使要花度六。</div>
                    </div>
                </div>
                <div className='flex items-center border-b border-lang p-4'>
                ...
                <div className='flex flex-col p-4 bg-gray-dark border-b border-lang text-black-darker font-normal text-xs'>
                    <div className='flex justify-between pb-4'>
                        ...
                        <div className='text-blue-light'>1Bq97r2dW814jmg…8J1Bq9</div>
                    </div>
                    <div className='flex justify-between pb-4'>
                        <div>Age</div>
